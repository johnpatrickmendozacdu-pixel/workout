...
const ICONS = {
  ...
  today: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M8.6 3h6.8L21 8.6v6.8L15.4 21H8.6L3 15.4V8.6z" stroke="currentColor" stroke-width="1.9" stroke-linejoin="miter"/><path d="M12 7.4V12l3.3 2.3" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="miter"/></svg>`,
  // Solid blocks, not hairlines — a plan is a stack of things you committed to.
  plan: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M4 5.6h16v2.7H4zM4 10.65h16v2.7H4zM4 15.7h9.4v2.7H4z" fill="currentColor"/></svg>`,
  // The same blocks stood up and climbing, so Plan and Progress stay siblings
  // without being twins.
  progress: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M3.6 13.4h3.6V20H3.6zM10.2 8.2h3.6V20h-3.6zM16.8 3.8h3.6V20h-3.6z" fill="currentColor"/></svg>`,
  ...
  book: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 6.4C10.4 5.1 8.3 4.4 5 4.4v13.2c3.3 0 5.4.7 7 2z" stroke="currentColor" stroke-width="1.9" stroke-linejoin="miter"/><path d="M12 6.4c1.6-1.3 3.7-2 7-2v13.2c-3.3 0-5.4.7-7 2z" stroke="currentColor" stroke-width="1.9" stroke-linejoin="miter"/></svg>`,
