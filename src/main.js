...
const ICONS = {
  ...
  today: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M8.6 3h6.8L21 8.6v6.8L15.4 21H8.6L3 15.4V8.6z" stroke="url(#metal)" stroke-width="1.9" stroke-linejoin="miter"/><path d="M12 7.4V12l3.3 2.3" stroke="url(#metal)" stroke-width="2" stroke-linecap="square" stroke-linejoin="miter"/></svg>`,
  // Solid blocks, not hairlines — a plan is a stack of things you committed to.
  plan: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M4 5.6h16v2.7H4zM4 10.65h16v2.7H4zM4 15.7h9.4v2.7H4z" fill="url(#metal)"/></svg>`,
  // The same blocks stood up and climbing, so Plan and Progress stay siblings
  // without being twins.
  progress: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M3.6 13.4h3.6V20H3.6zM10.2 8.2h3.6V20h-3.6zM16.8 3.8h3.6V20h-3.6z" fill="url(#metal)"/></svg>`,
  ...
  people: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><circle cx="9" cy="7.8" r="3.1" stroke="url(#metal)" stroke-width="1.9"/><path d="M3.4 19.6v-1.5c0-2.2 2.5-3.5 5.6-3.5s5.6 1.3 5.6 3.5v1.5" stroke="url(#metal)" stroke-width="1.9" stroke-linecap="square" stroke-linejoin="miter"/><circle cx="17.2" cy="9.2" r="2.4" stroke="url(#metal)" stroke-width="1.7"/><path d="M16.6 14.9c2.5.2 4 1.3 4 3.2v1.5" stroke="url(#metal)" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="miter"/></svg>`,
  ...
  book: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 6.4C10.4 5.1 8.3 4.4 5 4.4v13.2c3.3 0 5.4.7 7 2z" stroke="url(#metal)" stroke-width="1.9" stroke-linejoin="miter"/><path d="M12 6.4c1.6-1.3 3.7-2 7-2v13.2c-3.3 0-5.4.7-7 2z" stroke="url(#metal)" stroke-width="1.9" stroke-linejoin="miter"/></svg>`,
